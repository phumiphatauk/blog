...
func (server *Server) forgotPassword(ctx *gin.Context) {
	...
	link_reset_password := fmt.Sprintf("http://localhost:5173/reset-password?token=%s", token)
		...
		<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
			<div style="max-width: 600px; margin: auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
				...
				<p style="text-align: center;">
					<a href="%s" target="_blank" style="display: inline-block; background-color: #17A34A; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-size: 16px;cursor:pointer">
						Reset Password
					</a>
				</p>
				...
				Blog Example.Co.,Ltd.<br></p>
			</div>
		</body>
		</html>`, user.FirstName, link_reset_password)
